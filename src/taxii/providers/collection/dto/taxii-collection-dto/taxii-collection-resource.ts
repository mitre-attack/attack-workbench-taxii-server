...
export class TaxiiCollectionResource extends OmitType(TaxiiCollectionDto, [
  ...
  @ApiProperty({
    description: 'A human readable plan text title used to identify this Collection.',
    type: String,
    required: true,
  })
  title: string;
  ...
  @ApiProperty({
    description: 'A human readable plan text description used to identify this Collection.',
    type: String,
    required: false,
  })
  description: string;
