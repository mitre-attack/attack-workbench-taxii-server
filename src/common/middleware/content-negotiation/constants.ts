 ...
 */
const DEFAULT_MEDIA_TYPE = new MediaTypeObject('application/taxii+json;version=2.1');
Object.freeze(DEFAULT_MEDIA_TYPE);

const ALL_MEDIA_TYPES = ['application/taxii+json;version=2.1', 'application/taxii+json'];
