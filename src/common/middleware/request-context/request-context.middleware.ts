...
@Injectable()
export class RequestContextMiddleware<T extends RequestContextModel> implements NestMiddleware<Request, Response>, OnModuleInit {
    constructor(
...
export function requestContextMiddleware<T extends RequestContextModel>(contextClass: (new () => T),):
