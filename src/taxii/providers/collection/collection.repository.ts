...
export class CollectionRepository {
    ...
    async findOne(id: string): Promise<TaxiiCollectionDto> {
        ...
        const collections: StixObjectInterface[] = await this.stixRepo.getCollections(id);
    ...
    async findAll(): Promise<TaxiiCollectionsDto> {
        const stixCollections: StixObjectInterface[] = await this.stixRepo.getCollections();
