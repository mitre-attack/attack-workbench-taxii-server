...
| `TAXII_APP_PORT`              | int  | 8000                                                                                      | Specifies which port the server should listen on when HTTPS is disabled.                                                                                                                                                                  |
| `TAXII_APP_PORT_HTTPS`        | int  | 8443                                                                                      | Specifies which port the server should listen on when HTTPS is enabled.                                                                                                                                                                   |
...
| `TAXII_HTTPS_ENABLED`         | bool | false                                                                                     | Specifies whether the server should use HTTPS (SSL/TLS)                                                                                                                                                                                   |
