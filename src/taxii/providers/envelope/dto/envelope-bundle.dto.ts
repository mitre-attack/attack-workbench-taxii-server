...
export class EnvelopeBundleDto implements PaginationBundleInterface<EnvelopeDto>{
    ...
    findAfter(addedAfter: string) : EnvelopeDto {
        ...
        for (let i = 0; i < this.pages.length; i++) {
            ...
            let curOldestObjectInEnvelope = curEnvelope.items[curEnvelope.items.length-1].created
