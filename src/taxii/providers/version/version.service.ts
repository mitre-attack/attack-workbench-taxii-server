...
export class VersionService {
    ...
    (
        ...
        const filters = new ObjectFiltersDto({ collectionId, objectId, addedAfter, limit, match });
         ...
         */
        const objectVersions: string[] = objects.map(object => object.modified? object.modified : object.created );
