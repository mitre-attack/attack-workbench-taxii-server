...
export const configuration = registerAs("app", () => ({
  ...
  maxContentLength:
    process.env.TAXII_MAX_CONTENT_LENGTH || DEFAULTS.DEFAULT_MAX_CONTENT_LENGTH,
  apiRootPath:
    process.env.TAXII_API_ROOT_PATH || DEFAULTS.DEFAULT_API_ROOT_PATH,
  apiRootTitle:
    process.env.TAXII_API_ROOT_TITLE || DEFAULTS.DEFAULT_API_ROOT_TITLE,
  apiRootDescription:
    process.env.TAXII_API_ROOT_DESCRIPTION ||
  ...
  cacheMaxValueSize:
    process.env.TAXII_CACHE_MAX_ITEM_SIZE ||
    DEFAULTS.DEFAULT_CACHE_MAX_ITEM_SIZE,
  cacheReconnect:
    process.env.TAXII_CACHE_RECONNECT || DEFAULTS.DEFAULT_CACHE_RECONNECT,
  ...
  httpsEnabled:
    process.env.TAXII_HTTPS_ENABLED || DEFAULTS.DEFAULT_HTTPS_ENABLED,
