...
export class ManifestService {
    ...
    {
        const searchFilters = new ObjectFiltersDto({ collectionId, addedAfter, limit, match });
        ...
        const manifestRecords = await this.manifestRecordService.objectsToManifestRecords(stixObjects);

        // Paginate the manifest-records and return the appropriate page
        return await this.paginationService.getManifests(manifestRecords, limit, next);
    }
